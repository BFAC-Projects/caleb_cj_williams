...
class RemoteConfigService {
  ...
  String get shareUrlWithFallback => shareUrl.isNotEmpty 
      ? shareUrl 
      : Platform.isAndroid 
          ? 'https://play.google.com/store/apps/details?id=app.android.caleb_cj_williams'
  ...
  Future<void> initialize() async {
    try {
      ...
      // Set fallback values
      _shareMessage = 'Follow Caleb CJ Williams and stay updated with stats, highlights, and news. Download the app now:';
      _androidShareUrl = 'https://play.google.com/store/apps/details?id=app.android.caleb_cj_williams';
      _iosShareUrl = 'https://apps.apple.com/app/caleb-cj-williams/id123456789';
  ...
  Future<void> refreshInBackground() async {
    try {
      ...
      print('- Updated show hamburger menu: $_showHamburgerMenu');
