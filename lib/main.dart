...
Future<void> _showForegroundNotification(RemoteMessage message) async {
  const AndroidNotificationDetails androidPlatformChannelSpecifics =
    ...
    'caleb_channel_id',
    'Caleb Notifications',
    channelDescription: 'Notifications for Caleb CJ Williams app',
...
void main() async {
  ...
  const AndroidNotificationChannel channel = AndroidNotificationChannel(
    'caleb_channel_id',
    'Caleb Notifications',
    description: 'Notifications for Caleb CJ Williams app',
    importance: Importance.max,
  );
  ...
  try {
    ...
    await remoteConfig.setDefaults({
      'android_share_url': 'https://play.google.com/store/apps/details?id=app.android.caleb_cj_williams',
      'ios_share_url': 'https://apps.apple.com/app/caleb-cj-williams/id123456789',
      'share_message': 'Follow Caleb CJ Williams and stay updated with stats, highlights, and news. Download the app now:',
      'show_banner': false,
